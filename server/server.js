...
// Adds available locales to use with express.
// Those locales will be used to select content based on browser's request.
...
// It also takes into account language defined in the request to support intl capabilities.
app.use(render);
...
// WHAT: Why not use express internal ability to run server?
